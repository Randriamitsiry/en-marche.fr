        ...
        <div className="idea-card">
            <div className="idea-card__content">
                ...
                <div className="idea-card__content__infos">
                    <span className="idea-card__content__infos__author">
                        <span className={
                            classnames(
                                ...
                                `idea-card__content__infos__author__type--${props.author.type.id}`)}>{props.author.type.text}</span>
                    ...
                    <span className="idea-card__content__infos__date">{new Date(props.createdAt).toLocaleDateString()}</span>
                    <span className="idea-card__content__infos__contributors">
                        <img className="idea-card__content__infos__contributors__icon" src="/assets/img/icn_20px_contributors.svg"/>
                    ...
                    <span className="idea-card__content__infos__comments">
                        <img className="idea-card__content__infos__contributors__icon" src="/assets/img/icn_20px_comments.svg"/>
